...
public class principal {
    ...
    static boolean construyeMatriz (char[][] arr, String[] dna ){
    ...
    static boolean hasmutation(String[] dna){
        ...
        * *****************************************************/
        ...
        /* secuencia horizontal + vertical + diagonal IZQ => DER */
        ...
        /*  secuencia horizontal + vertical + diagonal IZQ => DER + diagonal DER => IZQ */
    ...
    public static void main(String[] args) {
    	  System.out.println("Ingrese secuencia ADN para saber si es mutante o no");
          //String[] dna = {ATGCGA,CAGTGC,TTATGT,AGAAGG,CCCCTA,TCACTG};
          Scanner scan = new Scanner(System.in);
          String inputString = scan.nextLine();
          scan.close();
          // ejemplo pdf(preuba de conocimientos)  "ATGCGA,CAGTGC,TTATGT,AGAAGG,CCCCTA,TCACTG";
